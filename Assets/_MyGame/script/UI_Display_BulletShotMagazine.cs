...
public class UI_Display_BulletShotMagazine : UI_Display__Base
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < magazineSize; i++)
        {
            ...
            bulletIcon[i].transform.localPosition = new Vector3(i * wide / (magazineSize - 1) - wide / 2.0f, 0, 0);
        }
    }
    ...
    void BulletIconDisplay()
    {
        ...
        for (int i = 0; i < bulletIcon.Length; i++)
        {
            ...
            else bulletIcon[i].GetComponent<Image>().color = Color.yellow * new Color(1, 1, 1, .3f);
        }
    }
}
